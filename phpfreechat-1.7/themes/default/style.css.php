...
/*  background-repeat: repeat-xy;*/
  font-family: Share Tech Mono; /* without this rule, the tabs are not correctly display on FF */
}
...
div#pfc_channels_content {
  ...
  position: relative;
  width: 100%;
  border-right: 1px solid #37F79F;
  border-left: 1px solid #37F79F;
  border-bottom: 1px solid #37F79F;
  border-top: 1px solid #37F79F;
  background-color: black;
