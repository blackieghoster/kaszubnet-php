	...
	<div class="flex-container">
		<div class="clearfix">
			<div class="box_header">
				<div class="back">
					<p><a href="../main_menu.php">KASZUBnet</a>><a href="chronicle.php">Kronika</a>>Kronika_OldTown</p>
				</div>
				<p id="header">
					<div class="glitch" data-text="Kronika_OldTown">Kronika_OldTown</div>
				</p>
				<div class="box_menu">
					<p id="menu"> Menu</p>
					<ul>
						<li id="menu_list"><a href="pp/ot2116.php">Pora Przybyszów - 2116</a></li>
						<li id="menu_list"><a href="pp/ot2117.php">Pora Przybyszów - 2117</a></li>
						<li id="menu_list"><a href="pp/ot2118.php">Pora Przybyszów - 2118</a></li>
						<li id="menu_list"><a href="pp/ot2119.php">Pora Przybyszów - 2119</a></li>
					</ul>
				</div>
