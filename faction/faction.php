	...
	<div class="flex-container">
		<div class="clearfix">
			<div class="box_header">
				<div class="back">
					<p><a href="../main_menu.php">KASZUBnet</a>>Frakcja</p>
				</div>

				<p id="header">
					<div class="glitch" data-text="Frakcja">Frakcja</div>
				</p>

				<div class="box_menu">
					<p id="menu"> Menu</p>
					<ul>
						<li id="menu_list"><a href="members.php">Członkowie</a></li>
						<li id="menu_list"><a href="hierarchy.php">Hierarchia i role</a></li>
						<li id="menu_list"><a href="law.php">Prawo Przystani</a></li>
					</ul>
				</div>
			</div>
